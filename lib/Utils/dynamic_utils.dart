...
class DynamicLinkProvider {
  Future<String> createLink(String id) async {
    ...
    final ShortDynamicLink pollLink = await link.buildShortLink(parameters);

    return pollLink.shortUrl.toString();
  }

  Future<String> initDynamicLink() async {
    final PendingDynamicLinkData? instancLink = await FirebaseDynamicLinks.instance.getInitialLink();
    ...
    if (instancLink != null) {
      ...
      final Map<String, String> param = pollLink.queryParameters;
